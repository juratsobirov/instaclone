...
import 'package:instaclone_again/models/member_model.dart';
import 'package:instaclone_again/services/auth_service.dart';
import 'package:instaclone_again/services/log_service.dart';
import 'package:instaclone_again/services/utils_service.dart';
...
class DbService {
  ...
  static Future<Member> loadMember() async {
    ...
    var querySnapshot2 = await _firestore
        ...
        .get();
    member.followers_count = querySnapshot2.docs.length;
